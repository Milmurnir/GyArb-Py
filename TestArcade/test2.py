...
class Tile:
    def __init__(self,position):
        ...
        self.sprite = arcade.Sprite("C:\Projects\GyArb-Py\TestArcade\Images\\base.png")
...
class MyGameWindow(arcade.Window):
    ...
    def setup(self):
        ...
        self.playerSprite = arcade.Sprite("C:\Projects\GyArb-Py\TestArcade\Images\character.png",5,center_x=100,center_y=100)
